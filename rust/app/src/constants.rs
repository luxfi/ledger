...
pub const BIP32_PATH_ROOT_1: u32 = 0x8000_0000 + 60;
pub const MAX_BIP32_PATH_DEPTH: usize = 6;
// path prefix for signer_list and change_path lists
// It is the same for both and has 3 components m/44'/60'/0'/
...
pub mod version {
    lux_app_derive::version!("Makefile.version");
}
...
mod known_chains {
    ...
    lux_app_derive::unroll!("vendor/chainIDs.json");
}
