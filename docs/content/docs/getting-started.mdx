...
Where:
- `44'`: BIP44 standard
- `60'`: Lux coin type (Ethereum standard)
...
primaryPath := "m/44'/60'/0'/0/0"

// Secondary account
secondaryPath := "m/44'/60'/1'/0/0"

// Internal change address
changePath := "m/44'/60'/0'/1/0"
```
...
```go
// P-Chain address
pChainPath := "m/44'/60'/0'/0/0"

// X-Chain address
xChainPath := "m/44'/60'/0'/0/0"
...
func main() {
    ...
    addr, err := app.GetAddress("m/44'/60'/0'/0/0", false)
    if err != nil {
